    ...
    try {
      ...
      if (navigator.share && navigator.canShare?.({ files: [file] })) {
        await navigator.share({
          title: 'AURA Stylist - My Style Report',
      ...
      <div className="app-shell">
        ...
        <header className="nav-header glass-nav">
          <div className="nav-logo">
            AURA <span className="nav-logo-sub">Stylist</span>
          </div>
        ...
        <footer className="site-footer">
          <p className="footer-brand serif-text">AURA Stylist</p>
          ...
          <p className="footer-copy">&copy; 2026 AURA Stylist. All rights reserved.</p>
        </footer>
        ...
        <div className="page-content">
          ...
          <div className="report-capture" ref={reportRef}>
            <div className="report-capture-header">
              <span className="report-capture-logo serif-text">AURA <span className="nav-logo-sub">Stylist</span></span>
            </div>
            ...
            <div className="report-capture-footer">
              <p>AI Fashion Styling by AURA Stylist</p>
            </div>
          </div>
